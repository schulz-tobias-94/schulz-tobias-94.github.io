...
4. In the **Settings** of your repository, in the Pages section, set the source to **GitHub Actions**.
5. Wait for a few minutes and let the action complete. You can see the progress in the **Actions** tab. If completed successfully, the workflow deploys the generated `_site` artifact directly to GitHub Pages.
